...
c.fonts.default_family = f'{fontsize} "FantasqueSansMono Nerd Font"'
c.fonts.default_size = f'{fontsize}'
c.fonts.contextmenu = f'{fontsize} "FantasqueSansMono Nerd Font"'
c.fonts.completion.entry = f'{fontsize} "FantasqueSansMono Nerd Font"'    # Font used in the completion widget.
c.fonts.debug_console = f'{fontsize} "FantasqueSansMono Nerd Font"'       # Font used for the debugging console.
c.fonts.prompts = f'default_size FantasqueSansMono Nerd Font'       # Font used for prompts.
c.fonts.statusbar = f'{fontsize} "FantasqueSansMono Nerd Font"'           # Font used in the statusbar.
